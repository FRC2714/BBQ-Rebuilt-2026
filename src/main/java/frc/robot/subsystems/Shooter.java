...
public class Shooter extends SubsystemBase {
    ...
    private SparkFlex turretMotor = new SparkFlex(Constants.TurretConstants.kTurretShooterCanId, MotorType.kBrushless);
    ...
    // Creates a flywheel
    public Shooter() {
        turretMotor.configure(Configs.Flywheel.pivotConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    }
